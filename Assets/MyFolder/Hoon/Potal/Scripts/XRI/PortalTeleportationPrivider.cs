...
namespace VRPortalToolkit.XRI
{
    ...
    /// </summary>
    public class PortalTeleportationPrivider : UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationProvider
    {
        ...
        private float GetStartTime()
        {
            ...
            {
                _timeStartedField = typeof(UnityEngine.XR.Interaction.Toolkit.Locomotion.Teleportation.TeleportationProvider).GetField("m_TimeStarted", BindingFlags.NonPublic | BindingFlags.Instance);
